CLASS zcl_upload_data_script_4236 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data:      lt_acc_categ type table of zacc_categ_4236,
            lt_catego    type table of zcatego_4236,
            lt_clientes  type table of zclientes_4236,
            lt_clnts_lib type table of zclnts_lib_4236,
            lt_libros    type table of zlibros_4236.
...
******** TABLA1 ********
    ...
    delete from zacc_categ_4236.
    insert zacc_categ_4236 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from zcatego_4236.
    insert zcatego_4236 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from zclientes_4236.
    insert zclientes_4236 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from zclnts_lib_4236.
    insert zclnts_lib_4236 from table @lt_clnts_lib.

    if sy-subrc eq 0.
        out->write( |Clientes vs Libros: { sy-dbcnt } registros insertados| ).
    endif.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from zlibros_4236.
    insert zlibros_4236 from table @lt_libros.
